var VideoPlayer = (props) => (
  <div className="video-player">
    <div className="embed-responsive embed-responsive-16by9"> {console.log('props', props)}
...
// <iframe className="embed-responsive-item" src="https://www.youtube.com/embed/" + {window.exampleVideoData.id.videoId} + "" allowFullScreen></iframe>
